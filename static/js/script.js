...
function yourAge(){
    ...
    var ageOfYour=(2021-birthYear);
    var h1=document.createElement('h1');
    var answer=document.createTextNode("Your age is"+" "+ageOfYour);
...
//remove all images
    ...
    botDiv.innerHTML="<img src='" + imagesDatabase[botImageChoice] + "'height=150 style='box-shadow: 0px 10px 50px rgba(243,38, 24, 28);'>"
